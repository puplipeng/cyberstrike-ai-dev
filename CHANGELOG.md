...
APK 整包代码审计、流式工具调用容量、项目加载和资产筛选等更新见 [发布说明](docs/releases/2026-09-11.md)。

## 2026-09-08 源码更新

资产变化监控、批量扫描通道绑定、GitHub 监控误报过滤与时间窗口、Windows shell 和模型网关兼容修复已同步。发布范围及验证记录见 [本轮更新说明](docs/releases/2026-09-08.md)。
