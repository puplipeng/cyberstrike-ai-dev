	...
	spec := map[string]interface{}{
		...
		"components": map[string]interface{}{
			...
			"schemas": map[string]interface{}{
				...
				"Vulnerability": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"status": map[string]interface{}{
							"type":        "string",
							"description": "状态",
							"enum":        []string{"open", "confirmed", "fixed", "false_positive", "ignored", "submitted", "unsubmitted"},
						},
				...
				"HITLRequest": map[string]interface{}{
					"type": "object",
					"properties": map[string]interface{}{
						"enabled": map[string]interface{}{"type": "boolean", "description": "是否启用审批"},
						"mode": map[string]interface{}{
							"type": "string", "enum": []string{"off", "approval", "review_edit"}, "description": "审批模式",
						},
						"reviewer": map[string]interface{}{
							"type": "string", "enum": []string{"human", "audit_agent"}, "description": "审批方",
						},
						"sensitiveTools": map[string]interface{}{
							"type": "array", "items": map[string]interface{}{"type": "string"}, "description": "会话级免审批工具列表",
						},
						"timeoutSeconds": map[string]interface{}{"type": "integer", "minimum": 0, "description": "人工审批等待秒数；0 表示不限时"},
					},
				},
				"BatchTaskRequest": map[string]interface{}{
					...
					"properties": map[string]interface{}{
						...
						"hitl": map[string]interface{}{
							...
							"description": "创建和启动前固定的审批策略；显式 off 不继承全局审批",
						},
					},
				},
				...
				"CreateVulnerabilityRequest": map[string]interface{}{
					"type":     "object",
					"required": []string{"conversation_id", "title", "description", "severity", "type", "target", "impact", "recommendation"},
					"properties": map[string]interface{}{
