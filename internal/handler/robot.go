...
func robotCommandPermission(text string) (string, bool) {
	switch {
	case text == robotCmdHelp || text == "help" || text == "？" || text == "$1", text == robotCmdVersion || text == "version", text == robotCmdIdentity || text == "whoami":
		return "", true
...
func (h *RobotHandler) handleRobotCommand(platform, userID, text string) (string, bool) {
	...
	case text == robotCmdHelp || text == "help" || text == "？" || text == "$1":
