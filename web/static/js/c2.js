...
(function() {
    ...
    C2.deleteListener = async function(id) {
        if (!await appConfirm(c2t('c2.listeners.confirmDelete'))) return;
    ...
    C2.deleteSessionsByIds = async function(ids, confirmKey, confirmOpts) {
        if (!ids || !ids.length) {
            showToast(c2t('c2.sessions.toastSelectFirst'), 'warn');
            return Promise.resolve();
        }
        if (!await appConfirm(c2t(confirmKey, confirmOpts || { n: ids.length }))) return Promise.resolve();
    ...
    C2.killSession = async function(id) {
        if (!await appConfirm(c2t('c2.sessions.confirmExitSession'))) return;
    ...
    C2.deleteSessionRecord = async function(id) {
        if (!await appConfirm(c2t('c2.sessions.confirmDeleteSession'))) return;
    ...
    C2.deleteTaskById = async function(id) {
        if (!id) return;
        if (!await appConfirm(c2t('c2.tasks.confirmDeleteOne'))) return;
    ...
    C2.deleteSelectedTasks = async function() {
        const ids = C2.collectCheckedTaskIds();
        if (!ids.length) {
            showToast(c2t('c2.tasks.toastSelectFirst'), 'warn');
            return;
        }
        if (!await appConfirm(c2t('c2.tasks.confirmBatchDelete', { n: ids.length }))) return;
    ...
    C2.deleteEventById = async function(id) {
        if (!id) return;
        if (!await appConfirm(c2t('c2.events.confirmDeleteOne'))) return;
    ...
    C2.deleteSelectedEvents = async function() {
        const ids = C2.collectCheckedEventIds();
        if (!ids.length) {
            showToast(c2t('c2.events.toastSelectFirst'), 'warn');
            return;
        }
        if (!await appConfirm(c2t('c2.events.confirmBatchDelete', { n: ids.length }))) return;
    ...
    C2.connectEventStream = function() {
        ...
        C2.eventSource = openAuthenticatedEventStream(`${API_BASE}/events/stream`, {onmessage: (e) => {
            try {
    ...
    C2.deleteProfile = async function(id) {
        if (!await appConfirm(c2t('c2.profiles.confirmDelete'))) return;
